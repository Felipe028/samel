          ...
          <Card>
            <CardHeader>
              <S.CardCenter>
                ...
                <S.CardRight>
                <Button color="success" onClick={() => Save()}>Finalizar Atendimento</Button>
                </S.CardRight>
              </S.CardCenter>
            </CardHeader>
            <CardBody>
                  ...
                  <Card body>
                    ...
                    <CardText>
                      <FormGroup> 
                        ...
                        <Input type="textarea" name="descricao" onChange={e => setHda(e.target.value)} id="exampleDesc" />
                      </FormGroup>                  
                    </CardText>
                  </Card>
                </Col>
                <Col sm="6">
                  <Card body>
                    ...
                    <CardText>
                      <FormGroup> 
                        <Label for="exampleDesc">Descrição</Label>
                        <Input type="textarea" name="descricao" onChange={e => setHpp(e.target.value)} id="exampleDesc" />
                      </FormGroup>                  
                    </CardText>
                  </Card>
                </Col>
                  ...
                  <Col sm="6">
                    <Card body>
                      ...
                      <CardText>
                        <FormGroup> 
                          <Label for="exampleDesc">Descrição</Label>
                          <Input type="textarea" name="descricao" onChange={e => setHf(e.target.value)} id="exampleDesc" />
                        </FormGroup>                  
                      </CardText>
                    </Card>
                  </Col>
                  <Col sm="6">
                    <Card body>
                      ...
                      <CardText>
                        <FormGroup> 
                          <Label for="exampleDesc">Descrição</Label>
                          <Input type="textarea" name="descricao" onChange={e => setReceita(e.target.value)} id="exampleDesc" />
                        </FormGroup>                  
                      </CardText>
                    </Card>
                  </Col>
